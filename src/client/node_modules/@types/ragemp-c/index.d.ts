...
declare abstract class PedMp implements PedBaseMp {
	...
	setFaceFeature(index: number, scale: number): void;
	// TODO
  getFaceCameraPosition(): Vector3Mp;
  getFaceCameraRotation(): Vector3Mp;
}
...
declare abstract class PlayerMp implements PedBaseMp {
  ...
  setInactive(toggle: boolean): void;
...
declare abstract class BrowserMp {
  ...
  //#region custom extended fields
  isOpen: boolean;
  //#endregion

	call(eventName: string, ...args: any[]): void;
	callProc<T = any>(procName: string, ...args: any[]): Promise<T>;
  callEnvironmentEvent(eventName: string, ...args: any): void;
  ...
  setPage(name: string, eventName: string): Promise<void>;
  closeAllPages(): void;
...
declare abstract class CameraMp {
  ...
  moveToPosition(position: Vector3Mp, rotation: Vector3Mp, duration: number, pov?): void;
  setPositionAndRotation(position: Vector3Mp, rotation: Vector3Mp): void;
  setPosition(position: Vector3Mp): void;
  setRotation(rotation: Vector3Mp): void;
}
