...
declare abstract class PlayerMp {
  ...
  //#endregion custom extended fields
  accountId: number;
	characterId: number;
  ...
  //#region custom extended methods
  setAccountId(accountId: number | undefined): void;
  setCharacterId(characterId: number | undefined): void;
  setCharacterSlot(characterSlot: number | undefined): void;
  toSpawn(): void;
  setToFirstEmptyDimension(): void;
  setToGlobalDimension(): void;
  setBrowserPage(pageName: string): void;
  closeAllBrowserPages(): void;
  playClientAnimation(dict: string, name: string, flag: number, duration: number): void;
  setPositionAndHeading(position: Vector3Mp, heading: number): void;
  freeze(): void;
  unFreeze(): void;
  sendInfoNotify(subtitle: string, position: NotifyPosition): void;
  sendWarnNotify(subtitle: string, position: NotifyPosition): void;
  sendErrorNotify(subtitle: string, position: NotifyPosition): void;
  sendSuccessNotify(subtitle: string, position: NotifyPosition): void;
  setSyncClothes(clothesData?: any): void;
  async setFullCustomization(): Promise<void>;
  //#endregion
}
